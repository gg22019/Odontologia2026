...
@Entity
@Table(name = "persona_rol", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class PersonaRol implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.PersonaRol[ idPersonaRol=" + idPersonaRol + " ]";
    }
