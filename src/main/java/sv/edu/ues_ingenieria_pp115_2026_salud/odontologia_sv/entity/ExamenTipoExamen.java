...
@Entity
@Table(name = "examen_tipo_examen", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class ExamenTipoExamen implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.ExamenTipoExamen[ idExamenTipoExamen=" + idExamenTipoExamen + " ]";
    }
