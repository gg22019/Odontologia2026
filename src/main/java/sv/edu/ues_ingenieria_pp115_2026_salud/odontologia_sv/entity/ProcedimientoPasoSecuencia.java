...
@Entity
@Table(name = "procedimiento_paso_secuencia", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class ProcedimientoPasoSecuencia implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.ProcedimientoPasoSecuencia[ idProcedimientoPasoSecuencia=" + idProcedimientoPasoSecuencia + " ]";
    }
