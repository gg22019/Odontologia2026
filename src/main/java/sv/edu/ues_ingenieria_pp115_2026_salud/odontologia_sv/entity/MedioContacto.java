...
@Entity
@Table(name = "medio_contacto", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class MedioContacto implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.MedioContacto[ idMedioContacto=" + idMedioContacto + " ]";
    }
