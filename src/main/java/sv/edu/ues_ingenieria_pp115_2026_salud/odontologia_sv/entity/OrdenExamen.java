...
@Entity
@Table(name = "orden_examen", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class OrdenExamen implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.OrdenExamen[ idOrdenExamen=" + idOrdenExamen + " ]";
    }
