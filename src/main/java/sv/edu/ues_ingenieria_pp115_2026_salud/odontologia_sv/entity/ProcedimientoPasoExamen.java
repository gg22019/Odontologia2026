...
@Entity
@Table(name = "procedimiento_paso_examen", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class ProcedimientoPasoExamen implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.ProcedimientoPasoExamen[ idProcedimientoPasoExamen=" + idProcedimientoPasoExamen + " ]";
    }
