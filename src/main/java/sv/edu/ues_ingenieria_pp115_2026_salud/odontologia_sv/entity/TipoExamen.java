...
@Entity
@Table(name = "tipo_examen", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class TipoExamen implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.TipoExamen[ idTipoExamen=" + idTipoExamen + " ]";
    }
