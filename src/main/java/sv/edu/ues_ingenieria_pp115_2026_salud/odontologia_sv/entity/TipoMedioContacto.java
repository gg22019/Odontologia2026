...
@Entity
@Table(name = "tipo_medio_contacto", catalog = "odontologia_sv", schema = "public")
@NamedQueries({
...
public class TipoMedioContacto implements Serializable {
    ...
    public String toString() {
        return "sv.edu.ues_ingenieria_pp115_2026_salud.odontologia_sv.entity.TipoMedioContacto[ idTipoMedioContacto=" + idTipoMedioContacto + " ]";
    }
